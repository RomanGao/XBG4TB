...
#         imuts = []
        ...
        # imp["importance_abs"] = imp["importance"].abs()
        # imp = imp.sort_values(by='importance_abs',ascending=False)
        # imp.to_csv("/htju/gaocl/result_exp/3_data/perimp/nu/single/"+str(drug)+"_xgb_imp.csv", index=False)
#         print(imp.head(10))
        ...
        pi_features.to_csv("/htju/gaocl/result_exp/3_data/perimp/nu/single2/"+str(drug)+"_xgb.csv", index=False)
